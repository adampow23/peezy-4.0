...
- [ ] I5 firestore.rules + storage.rules deletion boundaries and §5 cleanup predicates over the reconciled taskReset marker; firestoreRules.test.js cases (Storage cases there, Decision 6).
