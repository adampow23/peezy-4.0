...
- [ ] I2 Outbound leases: notifySupport email/SMS, packageInventory email, submitCheckIn SMS, Anthropic messages.create in processInventory/researchTask/peezyChat; lease/payload/call-graph cases for every C6.2 caller.
