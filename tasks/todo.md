...
- [ ] I1c Fence integration, peezyChat.js, researchTask.js, packageInventory.js, processInventory.js (process success, process error, onInventoryRoomWritten only).
