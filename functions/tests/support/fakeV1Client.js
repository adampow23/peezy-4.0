 ...
 * Documents (valueType-discriminated Values, longs as strings, generated defaults on every response).
 */
...
class FakeV1Client {
  constructor({ projectId = "demo-peezy-phase1", documents = {}, scriptedResponses = null, onQuery = null } = {}) {
...
module.exports = { FakeV1Client, gapicValue, gapicFields, ts, ROOT };
