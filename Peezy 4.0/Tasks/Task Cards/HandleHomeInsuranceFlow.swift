...
// MARK: - Handle Home Insurance Flow
// Consolidated flow for all home/renter's/condo/homeowner's insurance tasks.
//
// 4 PATHS:
...
struct HandleHomeInsuranceFlow: View {
    let taskTitle = "Handle my home insurance"
    ...
    private var cardContent: some View {
        ...
        // ── Card 1: Do you have home insurance? ──
        case hasInsuranceCard:
            TaskFlowCompactTilesCard(
                taskTitle: taskTitle,
                question: "Do you currently have home insurance?",
                options: [
