//
//  TransferHomeownersInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Transfer Homeowners Insurance Flow
// PATTERN: Complex Survey (skip logic)
// current_provider card only shows when help_preference answer contains "help_me".

struct TransferHomeownersInsuranceFlow: View {
    let taskTitle = "Transfer homeowner's insurance"
    let workflowId = "transfer_homeowners_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Move your coverage from your current home to the new one.",
        ...
        case helpPreferenceCard:
            TaskFlowTilesCard(
                ...
                options: [
                    FlowOption(id: "help_me", label: "Yes, help me transfer it", icon: "hands.sparkles.fill"),
        ...
        case currentProviderCard:
            TaskFlowTilesCard(
                ...
                options: [
                    ...
                    FlowOption(id: "nationwide", label: "Nationwide", icon: "shield.fill"),
                    FlowOption(id: "liberty_mutual", label: "Liberty Mutual", icon: "shield.fill"),
                    FlowOption(id: "usaa", label: "USAA", icon: "shield.fill"),
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                title: "We're on it",
                bodyText: "We'll reach out and get your policy transferred.",
                primaryLabel: "Submit",
                showBack: true,
...
#if DEBUG
#Preview("Transfer Homeowners Insurance Flow") {
    TransferHomeownersInsuranceFlow(
        userId: "preview-user",
