//
//  TransferCondoInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Transfer Condo Insurance Flow
// PATTERN: Complex Survey (skip logic)
// current_provider card only shows when help_preference answer contains "help_me".

struct TransferCondoInsuranceFlow: View {
    let taskTitle = "Transfer your condo insurance"
    let workflowId = "transfer_condo_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Move your policy from your old condo to the new one.",
...
#if DEBUG
#Preview("Transfer Condo Insurance Flow") {
    TransferCondoInsuranceFlow(
        userId: "preview-user",
