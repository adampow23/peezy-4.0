...
struct CancelUtilitiesFlow: View {
    let taskTitle = "Cancel my utilities"
    let workflowId = "cancel_utilities"
    ...
    private var cardContent: some View {
        ...
        case confirmAddressCard:
            TaskFlowConfirmAddressCard(
                taskTitle: taskTitle,
                question: "Is this your current address?",
        ...
        case tipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Give them your forwarding address — credit refunds arrive by mail.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
