...
// MARK: - Manage Spin Flow

struct ManageSpinFlow: View {
    let taskTitle = "Handle my cycling membership"
    let workflowId = "manage_spin"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll cancel your current membership and help find you a new cycling studio near your new place."
        } else if cancelWantsPeezy {
            return "We'll cancel your current membership. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new cycling studio near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        case updateBusinessCard:
            TaskFlowBusinessSearchCard(
                ...
                placeholder: "Search for a cycling studio...",
                searchHint: "cycling studio",
