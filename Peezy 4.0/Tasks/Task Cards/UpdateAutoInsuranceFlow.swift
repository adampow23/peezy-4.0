...
// MARK: - Update Auto Insurance Flow
// PATTERN: Complex Survey (skip logic)
// current_provider card only shows when help_preference answer contains "help_me".

struct UpdateAutoInsuranceFlow: View {
    let taskTitle = "Update your auto insurance"
    let workflowId = "update_auto_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Your garaging address affects your rates — let's get this updated.",
        ...
        case helpPreferenceCard:
            TaskFlowTilesCard(
                ...
                options: [
                    FlowOption(id: "help_me", label: "Yes, help me update it", icon: "hands.sparkles.fill"),
        ...
        case currentProviderCard:
            TaskFlowTilesCard(
                ...
                options: [
                    ...
                    FlowOption(id: "geico", label: "GEICO", icon: "shield.fill"),
...
#if DEBUG
#Preview("Update Auto Insurance Flow") {
    UpdateAutoInsuranceFlow(
        userId: "preview-user",
