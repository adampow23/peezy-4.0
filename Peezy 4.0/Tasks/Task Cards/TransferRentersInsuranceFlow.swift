//
//  TransferRentersInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Transfer Renters Insurance Flow
// PATTERN: Complex Survey (skip logic)
// current_provider card only shows when help_preference answer contains "help_me".

struct TransferRentersInsuranceFlow: View {
    let taskTitle = "Transfer renter's insurance"
    let workflowId = "transfer_renters_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Update your existing policy to cover your new address.",
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                title: "We're on it",
                bodyText: "We'll reach out and get your policy transferred to the new address.",
                primaryLabel: "Submit",
                showBack: true,
...
#if DEBUG
#Preview("Transfer Renters Insurance Flow") {
    TransferRentersInsuranceFlow(
        userId: "preview-user",
