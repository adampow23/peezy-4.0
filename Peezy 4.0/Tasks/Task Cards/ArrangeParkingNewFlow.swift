...
struct ArrangeParkingNewFlow: View {
    let taskTitle = "Reserve unloading parking"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "We need to make sure the moving truck has a place to park at your new home.",
        ...
        // ── Card 1: Does your new place have a driveway or loading area? (single-select) ──
        case actionCard:
            TaskFlowTilesCard(
                taskTitle: taskTitle,
