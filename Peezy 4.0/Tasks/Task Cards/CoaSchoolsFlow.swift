//
//  CoaSchoolsFlow.swift
//  Peezy 4.0
//

import SwiftUI

// MARK: - CoA Schools Flow
// PATTERN: 0-question Pattern B — Title → Info → Summary with Firebase submission.

struct CoaSchoolsFlow: View {
    let taskTitle = "Update your child's school"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Since you're staying in the same district, this is a quick update.",
