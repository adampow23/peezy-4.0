//
//  SetupHomeownersInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Setup Homeowners Insurance Flow
// PATTERN: Simple Survey
// Short flow: Title → Single question → Summary with submission.

struct SetupHomeownersInsuranceFlow: View {
    let taskTitle = "Set up homeowner's insurance"
    let workflowId = "setup_homeowners_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Your lender requires this before closing.",
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                title: "We're on it",
                bodyText: "We'll find you the best options. Need this bound at least 1 week before closing.",
                primaryLabel: "Submit",
                showBack: true,
...
#if DEBUG
#Preview("Setup Homeowners Insurance Flow") {
    SetupHomeownersInsuranceFlow(
        userId: "preview-user",
