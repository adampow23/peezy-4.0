    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                taskTitle: taskTitle,
                title: "Bank accounts",
                bodyText: "Let's make sure your accounts are accessible and your details are updated before you move.",
        ...
        case actionCard:
            TaskFlowTilesCard(
                ...
                options: [
                    FlowOption(id: "update_address", label: "Update address", icon: "pencil.line",
                               subtitle: "Keep your existing account"),
                    FlowOption(id: "close_open_new", label: "Open new account", icon: "arrow.triangle.swap",
                               subtitle: "Switch to a local branch"),
                    FlowOption(id: "already_handled", label: "Already handled", icon: "checkmark.circle",
                               subtitle: "Mark this task as complete")
                ],
