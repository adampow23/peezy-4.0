...
struct ManageBankFlow: View {
    let taskTitle = "Handle my bank account"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll close your current account and help find you a new bank."
        } else if cancelWantsPeezy {
            return "We'll close your current account. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new bank near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        // ── Card 1: Update or Open New (single-select) ──
        case actionCard:
            TaskFlowSelect2Card(
                taskTitle: taskTitle,
                question: "What would you like to do?",
                option1: FlowOption(id: "update", label: "Update my address", icon: "pencil.line"),
                option2: FlowOption(id: "find_new", label: "Open a new account", icon: "magnifyingglass"),
        ...
        // ── Card 3: Which bank? (Peezy needs to know) ──
        case updateBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Which bank are you with?",
        ...
        case updateSummaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your bank and get your address updated.",
        ...
        case updateTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Most banks let you update your address through their app or online banking. Have your account number handy.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
        ...
        // ── Card 7: Want help closing your current account? ──
        case cancelDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Want help closing your current account?",
                showBack: true,
                onPeezy: {
        ...
        // ── Card 8: Which bank? (Peezy needs to know) ──
        case cancelBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Which bank are you with?",
        ...
        case findDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Would you like help finding a new bank near your new place?",
                showBack: true,
                onPeezy: {
        ...
        case findTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Close old accounts in person or by phone — online-only closure can leave pending transactions orphaned. Open the new account first so direct deposits transfer seamlessly.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
