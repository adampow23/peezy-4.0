...
struct DefrostFreezerFlow: View {
    let taskTitle = "Defrost my freezer"
    ...
    private var cardContent: some View {
        ...
        case infoCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "A freezer that's not fully defrosted leaks across the moving truck floor and ruins cardboard boxes on contact.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
