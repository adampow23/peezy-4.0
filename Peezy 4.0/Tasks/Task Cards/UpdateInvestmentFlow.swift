...
struct UpdateInvestmentFlow: View {
    let taskTitle = "Update investment accounts"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Let's handle your investment accounts.",
            ...
            TaskFlowTilesCard(
                ...
                options: [
                    FlowOption(id: "update_address", label: "Update my address", icon: "pencil.line",
                               subtitle: "Keep current accounts, update contact info"),
                    FlowOption(id: "help_transfer", label: "Help me transfer or consolidate", icon: "arrow.triangle.swap",
                               subtitle: "We'll research options for you"),
