//
//  CancelHomeownersInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Cancel Homeowners Insurance Flow
// PATTERN: Complex Survey (skip logic)
// current_provider card only shows when help_preference answer contains "help_me".

struct CancelHomeownersInsuranceFlow: View {
    let taskTitle = "Cancel homeowner's insurance"
    let workflowId = "cancel_homeowners_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Do not cancel before closing — you're liable until the deed transfers.",
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                title: "We're on it",
                bodyText: "We'll reach out and get this canceled effective your closing date.",
                primaryLabel: "Submit",
                showBack: true,
...
#if DEBUG
#Preview("Cancel Homeowners Insurance Flow") {
    CancelHomeownersInsuranceFlow(
        userId: "preview-user",
