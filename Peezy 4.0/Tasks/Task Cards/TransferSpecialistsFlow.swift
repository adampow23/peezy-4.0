...
struct TransferSpecialistsFlow: View {
    let taskTitle = "Handle my specialist"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll transfer your records and help find you a new specialist."
        } else if cancelWantsPeezy {
            return "We'll transfer your records. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new specialist near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        // ── Card 3: Which specialist? (Peezy needs to know) ──
        case updateBusinessCard:
        ...
        case updateSummaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your specialist and get your address updated.",
        ...
        case updateTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Most specialist offices let you update your address by calling the front desk or through their patient portal.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
        ...
        // ── Card 8: Who's your current specialist? (Peezy needs to know) ──
        case cancelBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Who's your current specialist?",
                placeholder: "Search for a specialist's office...",
                searchHint: "medical specialist",
        ...
        case findDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Would you like help finding a new specialist near your new place?",
                showBack: true,
                onPeezy: {
        ...
        case findTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Request records be sent to your new provider before your first appointment. Ask your primary care doctor for specialist referrals near your new address — they often know the best options.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
