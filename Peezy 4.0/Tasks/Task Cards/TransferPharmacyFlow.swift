...
struct TransferPharmacyFlow: View {
    let taskTitle = "Handle my pharmacy"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll transfer your prescriptions and help find you a new pharmacy."
        } else if cancelWantsPeezy {
            return "We'll transfer your prescriptions. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new pharmacy near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        // ── Card 3: Which pharmacy? (Peezy needs to know) ──
        case updateBusinessCard:
        ...
        case updateSummaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your pharmacy and get your address updated.",
        ...
        case updateTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Most pharmacies let you update your address online or through their app. Have your prescription numbers handy.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
        ...
        // ── Card 7: Want help transferring your prescriptions? ──
        case cancelDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Want help transferring your prescriptions?",
                showBack: true,
                onPeezy: {
        ...
        // ── Card 8: Which pharmacy? (Peezy needs to know) ──
        case cancelBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Which pharmacy do you use?",
        ...
        case findDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Would you like help finding a new pharmacy near your new place?",
                showBack: true,
                onPeezy: {
        ...
        case findTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Most pharmacies can transfer prescriptions with just a phone call to the new location. Give them your name, date of birth, and current pharmacy — they handle the rest.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
