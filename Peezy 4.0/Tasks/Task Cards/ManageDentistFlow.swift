...
struct ManageDentistFlow: View {
    let taskTitle = "Handle my dentist"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll transfer your records and help find you a new dentist."
        } else if cancelWantsPeezy {
            return "We'll transfer your records. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new dentist near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        // ── Card 3: Which dentist? (Peezy needs to know) ──
        case updateBusinessCard:
        ...
        case updateSummaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your dentist and get your address updated.",
                showBack: true,
        ...
        case updateTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Most medical offices let you update your address by calling the front desk or through their patient portal.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
        ...
        // ── Card 8: Who's your current dentist? (Peezy needs to know) ──
        case cancelBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Who's your current dentist?",
                placeholder: "Search for a dental office...",
                searchHint: "dentist",
        ...
        case findDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Would you like help finding a new dentist near your new place?",
                showBack: true,
                onPeezy: {
        ...
        case findTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Call the front desk to request a records transfer — most offices can send them electronically including X-rays. For the new place, ask your insurance for in-network providers near your new address.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
