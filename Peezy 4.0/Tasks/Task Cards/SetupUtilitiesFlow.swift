...
struct SetupUtilitiesFlow: View {
    let taskTitle = "Set up my new utilities"
    ...
    private var cardContent: some View {
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll contact the utility providers to set up service at your new address before you arrive.",
                showBack: true,
        ...
        case tipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Get a 'letter of credit' from your old utility — waives the deposit.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
