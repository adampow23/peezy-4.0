//
//  SetupRentersInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Setup Renters Insurance Flow
// PATTERN: Simple Survey
// Short flow: Title → Single question → Summary with submission.

struct SetupRentersInsuranceFlow: View {
    let taskTitle = "Set up renter's insurance"
    let workflowId = "setup_renters_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Most leases require it, and it protects your stuff.",
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                title: "We're on it",
                bodyText: "We'll find you the best options and get you set up before move day.",
                primaryLabel: "Submit",
                showBack: true,
...
#if DEBUG
#Preview("Setup Renters Insurance Flow") {
    SetupRentersInsuranceFlow(
        userId: "preview-user",
