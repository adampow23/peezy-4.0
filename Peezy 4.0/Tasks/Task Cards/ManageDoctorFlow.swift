...
struct ManageDoctorFlow: View {
    let taskTitle = "Handle my primary doctor"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll transfer your records and help find you a new doctor."
        } else if cancelWantsPeezy {
            return "We'll transfer your records. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new doctor near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        // ── Card 3: Which doctor? (Peezy needs to know) ──
        case updateBusinessCard:
        ...
        case updateSummaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your doctor and get your address updated.",
                showBack: true,
        ...
        // ── Card 8: Who's your current doctor? (Peezy needs to know) ──
        case cancelBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Who's your current doctor?",
                placeholder: "Search for a doctor's office...",
                searchHint: "doctor",
        ...
        case findDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Would you like help finding a new doctor near your new place?",
                showBack: true,
                onPeezy: {
        ...
        case findTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Call the front desk to request a records transfer — most offices can send them electronically. For the new place, ask your insurance for in-network providers near your new address.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
