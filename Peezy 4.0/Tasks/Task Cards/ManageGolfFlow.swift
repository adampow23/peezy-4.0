//
//  ManageGolfFlow.swift
//  Peezy 4.0
//

import SwiftUI

// MARK: - Manage Golf Flow
// PATTERN: Simple Survey / Transfer-Cancel
// Short flow: Title → Single question → Summary with submission.

struct ManageGolfFlow: View {
    let taskTitle = "Handle your club membership"
    let workflowId = "manage_golf"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Let's figure out what you need for your golf or country club membership.",
