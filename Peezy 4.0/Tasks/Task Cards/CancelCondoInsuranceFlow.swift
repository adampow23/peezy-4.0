//
//  CancelCondoInsuranceFlow.swift
//  Peezy 4.0
//
...
// MARK: - Cancel Condo Insurance Flow
// PATTERN: Complex Survey (skip logic)
// current_provider card only shows when help_preference answer contains "help_me".

struct CancelCondoInsuranceFlow: View {
    let taskTitle = "Cancel your condo insurance"
    let workflowId = "cancel_condo_insurance"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "Cancel effective your closing date, not your move-out date.",
...
#if DEBUG
#Preview("Cancel Condo Insurance Flow") {
    CancelCondoInsuranceFlow(
        userId: "preview-user",
