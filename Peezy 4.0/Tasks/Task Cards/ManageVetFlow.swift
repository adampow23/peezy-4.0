    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                taskTitle: taskTitle,
                title: "Your vet",
                bodyText: "Let's figure out what you need for your pet's vet care.",
        ...
        case actionCard:
            TaskFlowTilesCard(
                ...
                options: [
                    FlowOption(id: "transfer_records", label: "Find new vet & transfer records", icon: "doc.arrow.forward",
                               subtitle: "We'll help find a vet near your new home and transfer records"),
                    FlowOption(id: "update_address", label: "Update address with current vet", icon: "pencil.line",
                               subtitle: "Keep your current vet, just update your contact info"),
