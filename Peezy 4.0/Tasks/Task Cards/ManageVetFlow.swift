...
// MARK: - Manage Vet Flow

struct ManageVetFlow: View {
    let taskTitle = "Handle my vet"
    let workflowId = "manage_vet"
    ...
    private var findNewSummaryText: String {
        if cancelWantsPeezy && findWantsPeezy {
            return "We'll transfer your records and help find you a new vet."
        } else if cancelWantsPeezy {
            return "We'll transfer your records. You're all set to find a new one on your own."
        } else {
            return "We'll help find you a new vet near your new place."
        }
    }
    ...
    private var cardContent: some View {
        ...
        // ── Card 3: Which vet? (Peezy needs to know) ──
        case updateBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Who's your vet?",
                placeholder: "Search for a veterinary clinic...",
                searchHint: "veterinarian",
        ...
        case updateSummaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your vet and get your address updated.",
        ...
        case updateTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Most vet offices let you update your address by calling the front desk or through their patient portal.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
        ...
        // ── Card 7: Want help transferring your records? ──
        case cancelDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Want help transferring your records?",
                showBack: true,
                onPeezy: {
        ...
        // ── Card 8: Who's your current vet? (Peezy needs to know) ──
        case cancelBusinessCard:
            TaskFlowBusinessSearchCard(
                taskTitle: taskTitle,
                question: "Who's your current vet?",
                placeholder: "Search for a veterinary clinic...",
                searchHint: "veterinarian",
        ...
        case findDecisionCard:
            TaskFlowDecisionCard(
                taskTitle: taskTitle,
                question: "Would you like help finding a new vet near your new place?",
                showBack: true,
                onPeezy: {
        ...
        case findTipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Call the front desk to request a records transfer — make sure vaccination records are included. For the new place, ask other pet owners in your new neighborhood for recommendations.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
