//
//  TransferDaycareFlow.swift
//  Peezy 4.0
//

import SwiftUI

// MARK: - Transfer Daycare Flow
// PATTERN: 0-question Pattern B — Title → Info → Summary with Firebase submission.

struct TransferDaycareFlow: View {
    let taskTitle = "Update your daycare"
    ...
    private var cardContent: some View {
        ...
        case titleCard:
            TaskFlowTitleCard(
                ...
                bodyText: "We'll make sure there's no gap in care.",
        ...
        case infoCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Give written notice to your current daycare ASAP — most require 2-4 weeks. Ask about prorated refunds and request immunization records and developmental assessments.",
                primaryLabel: "Continue",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
