...
struct ReserveElevatorsNewFlow: View {
    let taskTitle = "Reserve my unloading elevator"
    ...
    private var cardContent: some View {
        ...
        case summaryCard:
            TaskFlowSummaryCard(
                taskTitle: taskTitle,
                bodyText: "We'll reach out to your new building and lock in a service elevator window for move day.",
                showBack: true,
        ...
        case tipCard:
            TaskFlowInfoCard(
                taskTitle: taskTitle,
                title: "Good to Know",
                bodyText: "Book the first morning slot — overtime starts at $100/hour.",
                primaryLabel: "Got it",
                showBack: true,
                onPrimary: { advance() },
                onBack: { goBack() }
