...
| PEEZY_STATE_REGEN_SPEC.md | KEEP | Active directive for regenerating the canonical state document at `e5a40e8`. |
...
Disposition totals: KEEP 31 | ARCHIVE 23 | UNKNOWN 3 | total 57.
